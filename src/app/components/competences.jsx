                ...
                <div className="row">
                    <div className="col-12">
                        <div className="bg-[#080512] wow zoomIn rounded-3xl text-center py-14 px-12 mt-[-60px]">
                            ...
                            <p className='text-[#B8B8B8] text-[18px] tracking-[0.8px] leading-[1.5em] my-[14px] mb-[75px]'>Voici les outils avec lesquels j&apos;ai pu acquérir des compétences<br></br> suite à mes projets personnelles et scolaires.</p>
